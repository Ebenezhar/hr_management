...
urlpatterns = [
    ...
    path(
        ...
        CountrySalaryMetricsAPIView.as_view(),
        name="country-salary-metrics",
    ),
    path(
        "metrics/job-title/<str:title>/",
        JobTitleSalaryMetricsAPIView.as_view(),
        name="job-title-salary-metrics",
    ),
]
